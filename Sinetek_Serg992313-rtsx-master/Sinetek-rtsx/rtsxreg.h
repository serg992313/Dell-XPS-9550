...
#define	RTSX_SD_PARTIAL_PWR_ON	0x02  //linux correction from 0x01 to 0x02
...
#define	RTSX_CARD_PULL_CTL4	0xFD63  //additional for RTS525a

#define	RTSX_PULL_CTL_DISABLE1		0x66
#define	RTSX_PULL_CTL_DISABLE2		0x55
#define	RTSX_PULL_CTL_DISABLE3		0xD5
#define	RTSX_PULL_CTL_DISABLE4    	0x55


#define	RTSX_PULL_CTL_ENABLE1		0x66
#define	RTSX_PULL_CTL_ENABLE2		0xAA
#define	RTSX_PULL_CTL_ENABLE3		0xE9
#define	RTSX_PULL_CTL_ENABLE4   	0xAA
...
#define   LDO_VCC_TUNE_MASK		0x07 // case rts525a
...
#define	RTSX_LDO3318_VCC3	0x07 // case rts525a
#define	RTSX_LDO3318_VCC4	0x06 // case rts525a
#define RTS525A_PM_CTRL3    0xFF7E // case rts525a
...
#define	RTSX_LDO_PWR_SEL_3V3	0x01   // correction from linux  0x01 to 0x03
